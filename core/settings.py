...
DEBUG = os.getenv("DEBUG", "False") == "True"  # Convertendo string para booleano
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('HOST'),  # Ex: 'localhost' ou '127.0.0.1'
        'PORT': os.getenv('PORT'),  # Porta padrão do SQL Server
    }
}
